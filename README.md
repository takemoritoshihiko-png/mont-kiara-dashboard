...
クアラルンプールとペナンの**コンドミニアム271・学校33・商業施設88・飲食店93**を、1枚の地図で見くらべるためのダッシュボード。「住まいモード」と、飲食店の訪問記録をつけられる「外食モード」の2モード。
...
npm test               # テスト 636件（データ整合性の契約を含む）
...
| `test/` | 20ファイル・636件。`integrity.test.js` が**データ整合性の契約** |
