...
クアラルンプールとペナンの**コンドミニアム271・学校33・商業施設88・飲食店131**を、1枚の地図で見くらべるためのダッシュボード。「住まいモード」と、飲食店の訪問記録をつけられる「外食モード」の2モード。
...
| `restaurants.json` | 飲食店131件（ミシュラン系50＋検証済み拡充43・9分類）。`tools/convert-v9-dining.js` が生成 |
