...
// ============================================================
// 2026-08-16: このバケツを使うセレクト(fDiningArea)は画面から畳んだ（地図上の
// エリアジャンプで用が足りるため）。判定と対応表はここに残す — 6班体制の調査で
// 作った「どのエリア名がどの付近に属するか」の知識そのものであり、捨てると
// 作り直しになる。matchesDining は f.diningArea を受け取れば今も効く。
