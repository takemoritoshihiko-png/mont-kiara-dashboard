# 候補箱 — 台帳の外にある「気になる店」(2026-08-08新設)

> 外部情報の役割は候補生成であって判断ではない(意見書5-2)。ここは台帳より薄い箱:
> 店名・エリア・出典・1行だけ。**台帳への昇格は「家族が実食して合格」のみ**(検証Cで独立ソースの相互重複ゼロが実証されたため、外部合意による昇格は不可能)。

## 検証C(2026-08-08)由来の44店は spec 2026-08-08-dining-purpose-rethink.md §2-3 の出典参照

| 店名 | エリア | ジャンル | 出典 | ひとこと |
|---|---|---|---|---|
| Restoran Kin Kin | Kampung Baru | チリパンミー | TimeOut 2025-05 | KL名物チリパンミーの元祖格 |
| Soong Kee Beef Noodles | Petaling Street | 牛肉麺 | TimeOut 2025-05 | チャイナタウン老舗 |
| Koha Bistro | Old Klang Road | ビストロ | MalayMail 2026-08-02 | Dewakan出身シェフ |
| Tiffin Room 17 | PJ Sec 17 | チキンチョップ | EDKL 2026-08-07 | crackly classic |
